...
def game(request):
    return render(request,"portal_app/game.html")

def shop(request):
    return render(request,"portal_app/shop.html")
...
def trends(request):
    ...
    return render(request,"portal_app/trends.html", {"videos": videos, "myList": myList})